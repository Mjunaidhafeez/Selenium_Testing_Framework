...
class EditPatient:
    ...
    demo_suffix_xapth='//*[@id="frmEditPatient_1"]/fieldset/div/div[1]/div[1]/div/div[1]/div/div[2]/div[1]/div[7]/div/input'
    ...
    def setdemo_suffix(self,suffix):
        self.driver.find_element(By.ID, self.demo_suffix_xapth).clear()
        self.driver.find_element(By.ID, self.demo_suffix_xapth).send_keys(suffix)
